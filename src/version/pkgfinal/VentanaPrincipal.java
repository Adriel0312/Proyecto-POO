...
static VentanaPrincipal ventanaP;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ventReservar ventanaNueva = new ventReservar();
        ventanaNueva.setVisible(true);
        ventanaNueva.setTitle("Ventana Reservas");
        ventanaP.setVisible(false);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        
      Registro ventanaNueva = new Registro();
      ventanaNueva.setVisible(true);
      ventanaNueva.setTitle("Ventana Registro");
      ventanaP.setVisible(false);
